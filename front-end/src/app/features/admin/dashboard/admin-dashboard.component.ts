            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
              ...
              <div class="space-y-3">
                ...
                <a
                  ...
                  class="flex items-center justify-between p-3 bg-amber-50 rounded-lg hover:bg-amber-100 transition-colors"
                >
                  <span class="text-amber-700">Paramètres plateforme</span>
                  <svg
